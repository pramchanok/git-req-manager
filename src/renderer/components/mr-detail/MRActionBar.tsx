        ...
        <div className="flex items-center gap-3">
          {mr.state === 'opened' && (
            <>
              ...
              <label
                className="flex items-center gap-1.5 text-xs text-gray-400 select-none cursor-pointer mr-1"
                title="ลบ source branch หลัง merge สำเร็จ"
              >
                <input
                  type="checkbox"
                  checked={removeSourceBranch}
                  onChange={(e) => onRemoveSourceBranchChange(e.target.checked)}
                  className="w-3.5 h-3.5 rounded border-gray-600 bg-gray-800 accent-blue-600 cursor-pointer"
                />
